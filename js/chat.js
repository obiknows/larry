...
$(document).ready(function(){
	...
	var lipsum=".";
	var response="Sign up below to recieve your answer.";
	...
	function getReply(){
		...
		var message="Sign up below to get started.";
		for (var i = 0; i < length; i++) {
			message+=source[start+i]+(i<length-1?" ":"");
		};
		message+=Math.random()<0.4?" ":"";
		message+=Math.random()<0.2?" :)":(Math.random()<0.2?" :0":"");
